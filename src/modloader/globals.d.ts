...
declare namespace Emscripten {
    ...
    export class EmscriptenClassHandle {
    }

    export class EmscriptenRegisteredClass {
        baseClass: any;
    ...
    export class EmscriptenRegisteredPointer {
    ...
    export class EmscriptenWireType {
        ptr: number;
        ptrType: EmscriptenRegisteredPointer;
        count: { value: number };
    }

    export class EmscriptenClassReference {
        $$: EmscriptenWireType;
    }

    export class EmscriptenClass extends EmscriptenClassReference {
        delete(): void;
    }
...
declare namespace Bind {
    // emcc -s MODULARIZE=0
    // const Module: Module; export default Module;
    ...
    export interface Module extends Emscripten.EmscriptenModule {
        ...
        // - Those are merely shortcut to calling Text() with a format string. Output single value in "name: value" format (tip: freely more in your code to handle your types. you can add functions to the ImGui namespace)
...
declare namespace ImGui {
    ...
    export default (value?: Partial<Bind.Module>): Promise<void>;
    export { bind };
    export { IMGUI_VERSION as VERSION };
    export const IMGUI_VERSION: string;
    export { IMGUI_VERSION_NUM as VERSION_NUM };
    export const IMGUI_VERSION_NUM: number;
    export { IMGUI_CHECKVERSION as CHECKVERSION };
    export function IMGUI_CHECKVERSION(): boolean;
    export const IMGUI_HAS_TABLE: boolean;
    export function ASSERT(c: any): asserts c;
    export function IM_ASSERT(c: any): asserts c;
    ...
    export const IMGUI_PAYLOAD_TYPE_COLOR_3F: string;
    export const IMGUI_PAYLOAD_TYPE_COLOR_4F: string;
    ...
    export const IM_UNICODE_CODEPOINT_MAX: number;
    ...
    export const IM_COL32_R_SHIFT: number;
    export const IM_COL32_G_SHIFT: number;
    export const IM_COL32_B_SHIFT: number;
    export const IM_COL32_A_SHIFT: number;
    export const IM_COL32_A_MASK: number;
    export { IM_COL32 as COL32 };
    export function IM_COL32(R: number, G: number, B: number, A?: number): number;
    export const IM_COL32_WHITE: number;
    export { IM_COL32_WHITE as COL32_WHITE };
    export const IM_COL32_BLACK: number;
    export { IM_COL32_BLACK as COL32_BLACK };
    export const IM_COL32_BLACK_TRANS: number;
    ...
    export const ImGuiInputTextDefaultSize: number;
    ...
    export const IM_DRAWLIST_TEX_LINES_WIDTH_MAX: number;
    ...
    export function CreateContext(shared_font_atlas?: ImFontAtlas | null): ImGuiContext | null;
    ...
    export function ShowDemoWindow(p_open?: Bind.ImScalar<boolean> | null): void;
    export function ShowMetricsWindow(p_open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null): void;
    export function ShowStackToolWindow(p_open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null): void;
    export function ShowAboutWindow(p_open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null): void;
    ...
    export function Begin(name: string, open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null, flags?: ImGuiWindowFlags): boolean;
    export function End(): void;
    export function BeginChild(id: string | ImGuiID, size?: Readonly<Bind.interface_ImVec2>, border?: boolean, flags?: ImGuiWindowFlags): boolean;
    ...
    export function GetWindowPos(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetWindowSize(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetWindowWidth(): number;
    export function GetWindowHeight(): number;
    export function SetNextWindowPos(pos: Readonly<Bind.interface_ImVec2>, cond?: ImGuiCond, pivot?: Readonly<Bind.interface_ImVec2>): void;
    export function SetNextWindowSize(pos: Readonly<Bind.interface_ImVec2>, cond?: ImGuiCond): void;
    ...
    export function SetWindowPos(name_or_pos: string | Readonly<Bind.interface_ImVec2>, pos_or_cond?: Readonly<Bind.interface_ImVec2> | ImGuiCond, cond?: ImGuiCond): void;
    export function SetWindowSize(name_or_size: string | Readonly<Bind.interface_ImVec2>, size_or_cond?: Readonly<Bind.interface_ImVec2> | ImGuiCond, cond?: ImGuiCond): void;
    export function SetWindowCollapsed(name_or_collapsed: string | boolean, collapsed_or_cond?: boolean | ImGuiCond, cond?: ImGuiCond): void;
    export function SetWindowFocus(name?: string): void;
    export function SetWindowFontScale(scale: number): void;
    export function GetContentRegionAvail(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetContentRegionMax(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetWindowContentRegionMin(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetWindowContentRegionMax(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    ...
    export function SetScrollFromPosX(pos_x: number, center_x_ratio?: number): void;
    export function SetScrollFromPosY(pos_y: number, center_y_ratio?: number): void;
    export function PushFont(font: ImFont | null): void;
    ...
    export function PushTextWrapPos(wrap_pos_x?: number): void;
    export function PopTextWrapPos(): void;
    export function GetFont(): ImFont;
    export function GetFontSize(): number;
    export function GetFontTexUvWhitePixel(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    ...
    export function SameLine(pos_x?: number, spacing_w?: number): void;
    export function NewLine(): void;
    export function Spacing(): void;
    export function Dummy(size: Readonly<Bind.interface_ImVec2>): void;
    ...
    export function GetCursorPos(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetCursorPosX(): number;
    export function GetCursorPosY(): number;
    export function SetCursorPos(local_pos: Readonly<Bind.interface_ImVec2>): void;
    export function SetCursorPosX(x: number): void;
    export function SetCursorPosY(y: number): void;
    export function GetCursorStartPos(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetCursorScreenPos(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function SetCursorScreenPos(pos: Readonly<Bind.interface_ImVec2>): void;
    ...
    export function TextUnformatted(text: string, text_end?: number | null): void;
    export function Text(text: string): void;
    export function TextColored(col: Readonly<Bind.interface_ImVec4> | Readonly<ImColor>, text: string): void;
    ...
    export function Button(label: string, size?: Readonly<Bind.interface_ImVec2>): boolean;
    export function SmallButton(label: string): boolean;
    export function ArrowButton(str_id: string, dir: ImGuiDir): boolean;
    export function InvisibleButton(str_id: string, size: Readonly<Bind.interface_ImVec2>, flags?: ImGuiButtonFlags): boolean;
    export function Image(user_texture_id: ImTextureID | null, size: Readonly<Bind.interface_ImVec2>, uv0?: Readonly<Bind.interface_ImVec2>, uv1?: Readonly<Bind.interface_ImVec2>, tint_col?: Readonly<Bind.interface_ImVec4>, border_col?: Readonly<Bind.interface_ImVec4>): void;
    export function ImageButton(user_texture_id: ImTextureID | null, size?: Readonly<Bind.interface_ImVec2>, uv0?: Readonly<Bind.interface_ImVec2>, uv1?: Readonly<Bind.interface_ImVec2>, frame_padding?: number, bg_col?: Readonly<Bind.interface_ImVec4>, tint_col?: Readonly<Bind.interface_ImVec4>): boolean;
    ...
    export function ProgressBar(fraction: number, size_arg?: Readonly<Bind.interface_ImVec2>, overlay?: string | null): void;
    export function Bullet(): void;
    export function BeginCombo(label: string, preview_value?: string | null, flags?: ImGuiComboFlags): boolean;
    ...
    export function DragFloat(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, display_format?: string | null, flags?: ImGuiSliderFlags): boolean;
    export function DragFloat2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number> | ImVec2, v_speed?: number, v_min?: number, v_max?: number, display_format?: string, flags?: ImGuiSliderFlags): boolean;
    export function DragFloat3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, display_format?: string, flags?: ImGuiSliderFlags): boolean;
    export function DragFloat4(label: string, v: XYZW | Bind.ImTuple4<number> | ImVec4, v_speed?: number, v_min?: number, v_max?: number, display_format?: string, flags?: ImGuiSliderFlags): boolean;
    ...
    export function DragInt(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function DragInt2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function DragInt3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function DragInt4(label: string, v: XYZW | Bind.ImTuple4<number>, v_speed?: number, v_min?: number, v_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    ...
    export function DragScalar(label: string, v: Int8Array | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array, v_speed?: number, v_min?: number | null, v_max?: number | null, format?: string | null, flags?: ImGuiSliderFlags): boolean;
    export function SliderFloat(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderFloat2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec2, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderFloat3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderFloat4(label: string, v: XYZW | Bind.ImTuple4<number> | XYZW, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderAngle(label: string, v_rad: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_degrees_min?: number, v_degrees_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderAngle3(label: string, v_rad: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_degrees_min?: number, v_degrees_max?: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderInt(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderInt2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderInt3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderInt4(label: string, v: XYZW | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function SliderScalar(label: string, v: Int8Array | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array, v_min: number, v_max: number, format?: string | null, flags?: ImGuiSliderFlags): boolean;
    export function VSliderFloat(label: string, size: Readonly<Bind.interface_ImVec2>, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function VSliderInt(label: string, size: Readonly<Bind.interface_ImVec2>, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, v_min: number, v_max: number, format?: string, flags?: ImGuiSliderFlags): boolean;
    export function VSliderScalar(label: string, size: Readonly<Bind.interface_ImVec2>, data_type: ImGuiDataType, v: Bind.ImAccess<number> | Bind.ImScalar<number>, v_min: number, v_max: number, format?: string | null, flags?: ImGuiSliderFlags): boolean;
    export function InputText<T>(label: string, buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>, buf_size?: number, flags?: ImGuiInputTextFlags, callback?: ImGuiInputTextCallback<T> | null, user_data?: T | null): boolean;
    export function InputTextMultiline<T>(label: string, buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>, buf_size?: number, size?: Readonly<Bind.interface_ImVec2>, flags?: ImGuiInputTextFlags, callback?: ImGuiInputTextCallback<T> | null, user_data?: T | null): boolean;
    export function InputTextWithHint<T>(label: string, hint: string, buf: ImStringBuffer | Bind.ImAccess<string> | Bind.ImScalar<string>, buf_size?: number, flags?: ImGuiInputTextFlags, callback?: ImGuiInputTextCallback<T> | null, user_data?: T | null): boolean;
    export function InputFloat(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, step?: number, step_fast?: number, format?: string, flags?: ImGuiInputTextFlags): boolean;
    export function InputFloat2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, format?: string, flags?: ImGuiInputTextFlags): boolean;
    export function InputFloat3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, format?: string, flags?: ImGuiInputTextFlags): boolean;
    export function InputFloat4(label: string, v: XYZW | Bind.ImTuple4<number>, format?: string, flags?: ImGuiInputTextFlags): boolean;
    export function InputInt(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, step?: number, step_fast?: number, flags?: ImGuiInputTextFlags): boolean;
    export function InputInt2(label: string, v: XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, flags?: ImGuiInputTextFlags): boolean;
    export function InputInt3(label: string, v: XYZ | XYZW | Bind.ImTuple3<number> | Bind.ImTuple4<number>, flags?: ImGuiInputTextFlags): boolean;
    export function InputInt4(label: string, v: XYZW | Bind.ImTuple4<number>, flags?: ImGuiInputTextFlags): boolean;
    export function InputDouble(label: string, v: Bind.ImAccess<number> | Bind.ImScalar<number> | XY | XYZ | XYZW | Bind.ImTuple2<number> | Bind.ImTuple3<number> | Bind.ImTuple4<number>, step?: number, step_fast?: number, format?: string, flags?: ImGuiInputTextFlags): boolean;
    export function InputScalar(label: string, v: Int8Array | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array, step?: number | null, step_fast?: number | null, format?: string | null, flags?: ImGuiInputTextFlags): boolean;
    export function ColorEdit3(label: string, col: RGB | RGBA | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4, flags?: ImGuiColorEditFlags): boolean;
    export function ColorEdit4(label: string, col: RGBA | Bind.ImTuple4<number> | Bind.interface_ImVec4, flags?: ImGuiColorEditFlags): boolean;
    export function ColorPicker3(label: string, col: RGB | RGBA | Bind.ImTuple3<number> | Bind.ImTuple4<number> | Bind.interface_ImVec4, flags?: ImGuiColorEditFlags): boolean;
    export function ColorPicker4(label: string, col: RGBA | Bind.ImTuple4<number> | Bind.interface_ImVec4, flags?: ImGuiColorEditFlags, ref_col?: Bind.ImTuple4<number> | Bind.interface_ImVec4 | null): boolean;
    export function ColorButton(desc_id: string, col: Readonly<Bind.interface_ImVec4>, flags?: ImGuiColorEditFlags, size?: Readonly<Bind.interface_ImVec2>): boolean;
    ...
    export function BeginPopupModal(str_id: string, p_open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null, flags?: ImGuiWindowFlags): boolean;
    export function EndPopup(): void;
    export function OpenPopup(str_id: string, popup_flags?: ImGuiPopupFlags): void;
    export function OpenPopupOnItemClick(str_id?: string | null, popup_flags?: ImGuiPopupFlags): void;
    export function CloseCurrentPopup(): void;
    export function BeginPopupContextItem(str_id?: string | null, popup_flags?: ImGuiPopupFlags): boolean;
    export function BeginPopupContextWindow(str_id?: string | null, popup_flags?: ImGuiPopupFlags): boolean;
    export function BeginPopupContextVoid(str_id?: string | null, popup_flags?: ImGuiPopupFlags): boolean;
    export function IsPopupOpen(str_id: string, flags?: ImGuiPopupFlags): boolean;
    export function BeginTable(str_id: string, column: number, flags?: ImGuiTableFlags, outer_size?: Bind.interface_ImVec2, inner_width?: number): boolean;
    ...
    export function TableSetupColumn(label: string, flags?: ImGuiTableColumnFlags, init_width_or_weight?: number, user_id?: Bind.ImGuiID): void;
    ...
    export function TableSetBgColor(target: ImGuiTableBgTarget, color: Bind.ImU32, column_n?: number): void;
    export function Columns(count?: number, id?: string | null, border?: boolean): void;
    ...
    export function BeginTabItem(label: string, p_open?: Bind.ImScalar<boolean> | Bind.ImAccess<boolean> | null, flags?: ImGuiTabItemFlags): boolean;
    ...
    export function LogToTTY(max_depth?: number): void;
    export function LogToFile(max_depth?: number, filename?: string | null): void;
    export function LogToClipboard(max_depth?: number): void;
    ...
    export function SetDragDropPayload<T>(type: string, data: T, cond?: ImGuiCond): boolean;
    export function EndDragDropSource(): void;
    export function BeginDragDropTarget(): boolean;
    export function AcceptDragDropPayload<T>(type: string, flags?: ImGuiDragDropFlags): ImGuiPayload<T> | null;
    ...
    export function GetItemRectMin(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetItemRectMax(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetItemRectSize(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    ...
    export function BeginChildFrame(id: ImGuiID, size: Readonly<Bind.interface_ImVec2>, flags?: ImGuiWindowFlags): boolean;
    export function EndChildFrame(): void;
    export function CalcTextSize(text: string, text_end?: number | null, hide_text_after_double_hash?: boolean, wrap_width?: number, out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function ColorConvertU32ToFloat4(in_: Bind.ImU32, out?: Bind.interface_ImVec4): Bind.interface_ImVec4;
    export function ColorConvertFloat4ToU32(in_: Readonly<Bind.interface_ImVec4>): Bind.ImU32;
    export function ColorConvertRGBtoHSV(r: number, g: number, b: number, out_h: Bind.ImScalar<number>, out_s: Bind.ImScalar<number>, out_v: Bind.ImScalar<number>): void;
    export function ColorConvertHSVtoRGB(h: number, s: number, v: number, out_r: Bind.ImScalar<number>, out_g: Bind.ImScalar<number>, out_b: Bind.ImScalar<number>): void;
    export function GetKeyIndex(imgui_key: ImGuiKey): number;
    export function IsKeyDown(user_key_index: number): boolean;
    export function IsKeyPressed(user_key_index: number, repeat?: boolean): boolean;
    ...
    export function CaptureKeyboardFromApp(capture?: boolean): void;
    ...
    export function GetMouseClickedCount(button: number): number;
    export function IsMouseReleased(button: number): boolean;
    export function IsMouseHoveringRect(r_min: Readonly<Bind.interface_ImVec2>, r_max: Readonly<Bind.interface_ImVec2>, clip?: boolean): boolean;
    export function IsMousePosValid(mouse_pos?: Readonly<Bind.interface_ImVec2> | null): boolean;
    export function IsAnyMouseDown(): boolean;
    export function GetMousePos(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function GetMousePosOnOpeningCurrentPopup(out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    export function IsMouseDragging(button?: number, lock_threshold?: number): boolean;
    export function GetMouseDragDelta(button?: number, lock_threshold?: number, out?: Bind.interface_ImVec2): Bind.interface_ImVec2;
    ...
    export function CaptureMouseFromApp(capture?: boolean): void;
    export function GetClipboardText(): string;
    export function SetClipboardText(text: string): void;
    export function LoadIniSettingsFromDisk(ini_filename: string): void;
    export function LoadIniSettingsFromMemory(ini_data: string, ini_size?: number): void;
    export function SaveIniSettingsToDisk(ini_filename: string): void;
    export function SaveIniSettingsToMemory(out_ini_size?: Bind.ImScalar<number> | null): string;
    ...
    export function SetAllocatorFunctions(alloc_func: (sz: number, user_data: any) => number, free_func: (ptr: number, user_data: any) => void, user_data?: any): void;
    export function MemAlloc(sz: number): void;
