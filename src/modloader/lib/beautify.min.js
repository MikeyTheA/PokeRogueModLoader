    ...
    !(function () {
        ...
        var n = [
                        ...
                        (T.prototype.print_block_commment = function (t, e) {
                            ...
                            if ((this.print_newline(!1, e), this.print_token_line_indentation(t), this._output.add_token(_[0]), this.print_newline(!1, e), 1 < _.length)) {
                                for (
                                    ...
                                    n ? (this.print_token_line_indentation(t), this._output.add_token(_[i].replace(/^\s+/g, ''))) : u && _[i] ? (this.print_token_line_indentation(t), this._output.add_token(_[i].substring(a))) : (this._output.current_line.set_indent(-1), this._output.add_token(_[i])), this.print_newline(!1, e);
                ...
                function (t, e, i) {
                    ...
                    function p(t, e) {
                        n.call(this, t, e), (this._patterns.whitespace = this._patterns.whitespace.matching(/\u00A0\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff/.source, /\u2028\u2029/.source)), (t = new a(this._input)), (e = new o(this._input).read_options(this._options)), (this.__patterns = { template: e, identifier: e.starting_with(r.identifier).matching(r.identifierMatch), number: t.matching(d), punct: t.matching(k), comment: t.starting_with(/\/\//).until(/[\n\r\u2028\u2029]/), block_comment: t.starting_with(/\/\*/).until_after(/\*\//), html_comment_start: t.matching(/<!--/), html_comment_end: t.matching(/-->/), include: t.starting_with(/#include/).until_after(r.lineBreak), shebang: t.starting_with(/#!/).until_after(r.lineBreak), xml: t.matching(/[\s\S]*?<(\/?)([-a-zA-Z:0-9_.]+|{[^}]+?}|!\[CDATA\[[^\]]*?\]\]|)(\s*{[^}]+?}|\s+[-a-zA-Z:0-9_.]+|\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{([^{}]|{[^}]+?})+?}))*\s*(\/?)\s*>/), single_quote: e.until(/['\\\n\r\u2028\u2029]/), double_quote: e.until(/["\\\n\r\u2028\u2029]/), template_text: e.until(/[`\\$]/), template_expression: e.until(/[`}\\]/) });
                    }
                    var l,
                        f = { START_EXPR: 'TK_START_EXPR', END_EXPR: 'TK_END_EXPR', START_BLOCK: 'TK_START_BLOCK', END_BLOCK: 'TK_END_BLOCK', WORD: 'TK_WORD', RESERVED: 'TK_RESERVED', SEMICOLON: 'TK_SEMICOLON', STRING: 'TK_STRING', EQUALS: 'TK_EQUALS', OPERATOR: 'TK_OPERATOR', COMMA: 'TK_COMMA', BLOCK_COMMENT: 'TK_BLOCK_COMMENT', COMMENT: 'TK_COMMENT', DOT: 'TK_DOT', UNKNOWN: 'TK_UNKNOWN', START: u.START, RAW: u.RAW, EOF: u.EOF },
                        c = new s(/\/\*/, /\*\//),
