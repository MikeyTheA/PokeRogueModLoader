...
export default class MenuUiHandler extends MessageUiHandler {
	...
	render() {
		...
		this.menuBg = addWindow(this.scene, this.scene.game.canvas.width / 6 - (this.optionSelectText.displayWidth + 25), 0, this.optionSelectText.displayWidth + 19 + 24 * this.scale, this.scene.game.canvas.height / 6 - 2);
